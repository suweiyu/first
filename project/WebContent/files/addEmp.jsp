...
<body class="ContentBody">
  <form action="addEmp" method="post"  name="form"  >
<div class="MainDiv">
			...
			<TD width="100%">
				...
				<legend>员工信息</legend>
					  ...
					  <tr>
					    ...
					    <td width="35%"><input name='empNo' type="text" class="text" style="width:154px" value="" />
				        <span class="red">*</span></td>
					    <td width="16%" align="right" nowrap="nowrap">密码:</td>
					    <td width="34%"><input class="text" name='password' style="width:154px" value=""/></td>
					  </tr>
					    
					    
					  <tr>
					    <td nowrap="nowrap" align="right">真实姓名:</td>
					    <td><input class="text" name='empName' style="width:154px" value=""/></td>
					  ...
					  <tr>
					    ...
					    <td><input class="text" name='birth' style="width:154px" value=""/>格式:xxxx-xx-xx</td>
					  ...
					  <tr>
					    ...
					    <td><input class="text" name='hiredate' style="width:154px" value=""/>格式:xxxx-xx-xx</td>
					    <td align="right">&nbsp;</td>
					    <td>&nbsp;</td>
					  </tr>
